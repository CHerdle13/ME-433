...
public class SerialConsoleActivity extends Activity implements TextureView.SurfaceTextureListener {
    ...
    public void onSurfaceTextureUpdated(SurfaceTexture surface) {
        ...
        if (c != null) {
            ...
            byte bCOM1 = (byte) ((int)(COM/4));
            byte bCOM2 = (byte) ((int)(COM/4));
            byte bCOM3 = (byte) ((int)(COM/4));
            byte bFOUND1 = (byte) linefound1;
            byte bFOUND2 = (byte) linefound2;
            byte bFOUND3 = (byte) linefound3;

            byte[] sData = {bCOM1,bCOM2,bCOM3,bFOUND1,bFOUND2,bFOUND3,0}; try {sPort.write(sData, 10);} catch (IOException e) {}
            ...
            canvas.drawText("COM2 = " + COM2, 10, 250, paint1);
            canvas.drawText("COM3 = " + COM3, 10, 300, paint1);
